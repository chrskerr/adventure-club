...
summary: 'Fun trail through a beautifully diverse alpine region'
tileImage: '@/assets/mount_field/1.jpeg'
gpxFile: 'https://www.wildertrails.com.au/explore-wilder-trails/fields-of-gold'

region: 'South West'
startLatLng: [-42.685484, 146.593521]
...
import image1 from '@/assets/mount_field/1.jpeg'
import image2 from '@/assets/mount_field/2.jpeg'
import image3 from '@/assets/mount_field/3.jpeg'
import image4 from '@/assets/mount_field/4.jpeg'
import image5 from '@/assets/mount_field/5.jpeg'
...
**GPX file**: Available through <a target="_blank" href="https://www.wildertrails.com.au/explore-wilder-trails/fields-of-gold">Wilder Trails</a> for $5. They're a great organisation to support!

<ImageCard
  src={image3}
  alt="Fagus trees"
  caption="Fagus trees on full display for us today!"
/>
...
<ImageCard
  src={image2}
  alt="Chris standing at peak"
  caption="Great views on the back half of the run"
/>
...
<ImageCard
  src={image4}
  alt="Fagus trees"
  caption="More Fagus trees...but closer"
/>
...
<ImageCard
  src={image5}
  alt="Lake Dobson"
  caption="Lake Dobson at the very end of the adventure"
/>
...
<ImageCard
  src={image1}
  alt="Lake views"
  caption="One of the many optional out and back bodies of water (maybe the Platypus Tarn?)"
/>
