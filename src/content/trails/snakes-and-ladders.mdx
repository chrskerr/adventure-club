...
tileImage: '@/assets/snakes/1.jpg'
gpxFile: 'https://www.wildertrails.com.au/explore-wilder-trails/snakes-and-ladders'

region: 'Hobart'
startLatLng: [-42.914647, 147.246405]
...
import ImageCarousel from '@/components/images/image_carousel.astro'
import { CarouselItem } from '@/components/carousel'
import ImageCard from '@/components/images/image_card.astro'
import image1 from '@/assets/snakes/1.jpg'
import image2 from '@/assets/snakes/2.jpg'
import image3 from '@/assets/snakes/3.jpg'
import image4 from '@/assets/snakes/4.jpg'
import image5 from '@/assets/snakes/5.jpg'
import image6 from '@/assets/snakes/6.jpg'
import image7 from '@/assets/snakes/7.jpg'
import image8 from '@/assets/snakes/8.jpeg'
import image9 from '@/assets/snakes/9.jpeg'
import image10 from '@/assets/snakes/10.jpeg'
...
**GPX file**: Available through <a target="_blank" href="https://www.wildertrails.com.au/explore-wilder-trails/snakes-and-ladders">Wilder Trails</a> for $5. They're a great organisation to support!

<ImageCard
  src={image1}
  alt="runner in bushland"
  caption="A day of epic adventure"
/>
...
<ImageCard
  src={image2}
  alt="view of boulders"
  caption="The 'Potato Fields' - a very very large rock garden"
/>
...
<ImageCard
  src={image5}
  alt="woman running past stream"
  caption="One of the river crossings along the way..."
/>
...
<ImageCard
  src={image10}
  alt="nature view"
  caption="Views from somewhere near the top"
/>
...
<ImageCarousel
  images={[
    { src: image6, alt: 'woman in bushland', caption: 'Getting technical' },
    { src: image3, alt: 'woman running across boulders' },
    { src: image4, alt: 'woman standing in bushland' },
    { src: image7, alt: 'woman running past boulder' },
    { src: image8, alt: 'mushrooms growing on moss' },
    { src: image9, alt: 'view of mountains' },
  ]}
/>
